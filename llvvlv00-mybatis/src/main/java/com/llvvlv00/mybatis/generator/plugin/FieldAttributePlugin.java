...
//        root.addImportedType(model + "." + queryVoName);
        ...
        root.addImportedType("com.llvvlv00.mybatis.help.DbField");
        root.addImportedType("com.llvvlv00.mybatis.help.FieldResult");
        ...
        for (IntrospectedColumn column : allColumns) {
            ...
            Field field = new Field(varName,
                    new FullyQualifiedJavaType("com.llvvlv00.mybatis.help.DbField"));
            ...
            setMethod.setReturnType(new FullyQualifiedJavaType("com.llvvlv00.mybatis.help.FieldResult"));
