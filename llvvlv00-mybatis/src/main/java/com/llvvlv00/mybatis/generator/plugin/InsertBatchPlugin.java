...
public class InsertBatchPlugin extends PluginAdapter {
    ...
    public boolean clientGenerated(Interface interfaze, IntrospectedTable introspectedTable) {
        generateBatchInsertMethod("insertBatch", interfaze, introspectedTable);
        return super.clientGenerated(interfaze, introspectedTable);
    }

    private void generateBatchInsertMethod(String methodName, Interface interfaze, IntrospectedTable introspectedTable) {
